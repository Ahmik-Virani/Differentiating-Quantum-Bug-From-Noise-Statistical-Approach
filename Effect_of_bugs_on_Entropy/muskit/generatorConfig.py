...
import math
maxNumberOfMutants = 15 # Maximum number of mutants to be generated
operators = ("Add", "Replace", "Remove") # Type of operators to be use to create mutants. Valid values are Add, Replace, Remove
# types = ("OneQubit")
types = ("OneQubit", "ManyQubit") # Types of gates the mutation will change, Valid values are OneQubit and ManyQubit
...
allMutants = True # If this variable is true, then all the possible mutants will be generated.